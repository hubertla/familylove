...
class PtsSliderLayerPreviewModuleFrontController extends ModuleFrontController {

    private $_nameModule = "ptssliderlayer";
    public $themeName;
    public $img_path;
    public $img_url;
    ...
    public function __construct()
    {
        ...
        $this->img_path = _PS_MODULE_DIR_.$this->_nameModule.'/images/';
        $this->img_url = _MODULE_DIR_ . $this->_nameModule. '/images/';
    ...
    public function display() {
        ...
        if(Tools::getValue("preview") && isset($sliders)){
        ...
        if (file_exists(_PS_THEME_DIR_ . 'modules/ptssliderlayer/ptssliderlayer.tpl')) {
            $ptssliderlayer_tpl = _PS_THEME_DIR_ . 'modules/ptssliderlayer/ptssliderlayer.tpl';
        } else {
            $ptssliderlayer_tpl = _PS_MODULE_DIR_ . 'ptssliderlayer/ptssliderlayer.tpl';
        }
        
        //add js + css
        $this->addJqueryPlugin('easing');
        $this->addJS(__PS_BASE_URI__.str_replace("//","/",'modules/ptssliderlayer') . '/js/raphael-min.js');
        $this->addJS(__PS_BASE_URI__.str_replace("//","/",'modules/ptssliderlayer') . '/js/iview.js');

        if (file_exists(_PS_THEME_DIR_ . 'css/modules/ptssliderlayer/css/typo.css')) {
            $this->context->controller->addCSS(_PS_THEME_DIR_ . 'css/modules/ptssliderlayer/css/typo.css');
        } else {
            $this->addCSS(__PS_BASE_URI__.str_replace("//","/",'modules/ptssliderlayer') . '/css/typo.css', 'all');
        }
        
        if (file_exists(_PS_THEME_DIR_ . 'css/modules/ptssliderlayer/css/style.css')) {
            $this->context->controller->addCSS(_PS_THEME_DIR_ . 'css/modules/ptssliderlayer/css/style.css');
        } else {
            $this->addCSS(__PS_BASE_URI__.str_replace("//","/",'modules/ptssliderlayer') . '/css/style.css', 'all');
        }
        ...
        $this->context->smarty->assign(array(
            ...
            'ptssliderlayer_tpl' => $ptssliderlayer_tpl,
    ...
    public function getSlide($id_slider, $id_lang) {
        return Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
                    ...
                    FROM ' . _DB_PREFIX_ . 'ptssliderlayer_slides lsl
                    LEFT JOIN ' . _DB_PREFIX_ . 'ptssliderlayer_slides_lang lsll ON (lsl.id_ptssliderlayer_slides = lsll.id_ptssliderlayer_slides)
                    WHERE lsl.id_ptssliderlayer_slides= ' . (int) $id_slider . ' AND lsll.id_lang = ' . (int) $id_lang);
    }
