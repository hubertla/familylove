...
<div class="blockcart_top clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if} pull-right text-right">
{/if}
		...
		<div class="media heading">
			...
			<div class="cart-inner media-body">
				...
				<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
					...
					<span class="ajax_cart_product_txt{if $cart_qties != 1} unvisible{/if} hidden-sp"> - {l s='item' mod='blockcart'}</span>
					<span class="ajax_cart_product_txt_s{if $cart_qties < 2} unvisible{/if} hidden-sp"> - {l s='item(s)' mod='blockcart'}</span>
