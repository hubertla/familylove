<?php /* Smarty version Smarty-3.1.19, created on 2017-03-27 19:31:27
         compiled from "/home/familylove/public_html/themes/pf_milky/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:172495249658d9061f3ac871-24057598%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a90a626f9625c687ecf82e5f98697d3150ef8cdd' => 
    array (
      0 => '/home/familylove/public_html/themes/pf_milky/modules/blockcart/blockcart.tpl',
      1 => 1490617399,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '172495249658d9061f3ac871-24057598',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58d9061f9428b8_90433527',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58d9061f9428b8_90433527')) {function content_58d9061f9428b8_90433527($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/familylove/public_html/tools/smarty/plugins/modifier.replace.php';
...
<div class="col-sm-12 clearfix <?php if ($_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?> header_user_catalog<?php }?>">
<?php }?>
...
" rel="nofollow">
			<b><?php echo smartyTranslate(array('s'=>'Shopping Bag -','mod'=>'blockcart'),$_smarty_tpl);?>
</b>
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
						...
						<p class="cart-buttons">
							<a id="button_order_cart" class="btn button button-small" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
