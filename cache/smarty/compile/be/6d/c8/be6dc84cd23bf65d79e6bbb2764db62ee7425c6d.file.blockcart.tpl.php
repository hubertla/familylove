<?php /* Smarty version Smarty-3.1.19, created on 2017-03-27 09:05:34
         compiled from "/home/familylove/public_html/themes/pf_basic/modules/blockcart/blockcart.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8686309558d90e1e5343c5-26239527%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'be6dc84cd23bf65d79e6bbb2764db62ee7425c6d' => 
    array (
      0 => '/home/familylove/public_html/themes/pf_basic/modules/blockcart/blockcart.tpl',
      1 => 1490619696,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '8686309558d90e1e5343c5-26239527',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58d90e1eb59a17_41230800',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58d90e1eb59a17_41230800')) {function content_58d90e1eb59a17_41230800($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/familylove/public_html/tools/smarty/plugins/modifier.replace.php';
...
" rel="nofollow">
					<span class="cart-title"><?php echo smartyTranslate(array('s'=>'shopping cart','mod'=>'blockcart'),$_smarty_tpl);?>
</span>
					<span class="ajax_cart_quantity mini-cart-count<?php if ($_smarty_tpl->tpl_vars['cart_qties']->value==0) {?> unvisible<?php }?>"><?php echo $_smarty_tpl->tpl_vars['cart_qties']->value;?>
</span>
...
</span> - <span><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>0),$_smarty_tpl);?>
</span>
					</span>
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['convertPrice'][0][0]->convertPrice(array('price'=>$_smarty_tpl->tpl_vars['cart']->value->getOrderTotal(true,$_smarty_tpl->tpl_vars['cart_flag']->value)),$_smarty_tpl);?>
						...
						<p class="cart-buttons clearfix">
							<a id="button_order_cart" class="btn btn-default button button-small pull-right" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink(((string)$_smarty_tpl->tpl_vars['order_process']->value),true), ENT_QUOTES, 'UTF-8', true);?>
